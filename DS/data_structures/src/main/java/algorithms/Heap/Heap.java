...
public class Heap<E> implements IHeap<E> {
    private Logger logger = LoggerFactory.getLogger(algorithms.Queue.PriorityQueue.class);
    ...
    public void grow(int minCapacity) {
        ...
        int newCapacity = oldCapacity + ((oldCapacity < 64) ? (oldCapacity + 1) : (oldCapacity >> 1));
    ...
    public void siftUpComparable(int k, E x) {
